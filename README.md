...
> [!IMPORTANT]
> Currently, this project only supports **Windows** (Linux support coming soon). Additionally, the **showCover** feature only works for anime at the moment.
...
Settings can be adjusted in `config.ts`:
