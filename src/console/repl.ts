...
export class ConsoleRepl extends EventEmitter {
     ...
     */
    updateContext(context: EpisodeContext | null): void {
    ...
    /**
     * Handle 'clear' command - remove manual override
     */
    ...
    private handleHelp(): void {
        ...
        console.log('  clear          - Remove active override');
